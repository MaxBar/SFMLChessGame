...
public abstract class GameState {
    ...
    public abstract void handleEvents(GameEngine game, RenderWindow window) throws IOException;
    
    public abstract void update(GameEngine game, RenderWindow window) throws IOException;
